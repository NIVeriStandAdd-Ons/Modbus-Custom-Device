...
<Project Type="Project" LVVersion="15008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="ModbusPharLap.lvlibp" Type="LVLibp" URL="../c/ModbusPharLap.lvlibp">
			<Item Name="API" Type="Folder">
				<Item Name="Master" Type="Folder">
					<Item Name="Modbus Master.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/API/Master/Modbus Master.lvclass"/>
				</Item>
				<Item Name="Slave" Type="Folder">
					<Item Name="Check Object Lengths.vi" Type="VI" URL="../c/ModbusPharLap.lvlibp/Modbus Library/API/Slave/Check Object Lengths.vi"/>
					<Item Name="Modbus Slave.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/API/Slave/Modbus Slave.lvclass"/>
				</Item>
				<Item Name="Wrapper" Type="Folder">
					<Item Name="API Main.lvlib" Type="Library" URL="../c/ModbusPharLap.lvlibp/Modbus Library/API/Wrapper/API Main.lvlib"/>
				</Item>
				<Item Name="Modbus API.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/API/Modbus API.lvclass"/>
			</Item>
			<Item Name="Data Model" Type="Folder">
				<Item Name="Device Data Model.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Data Model/Device Data Model.lvclass"/>
			</Item>
			<Item Name="Examples" Type="Folder">
				<Item Name="Modbus Master Example.vi" Type="VI" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Examples/Modbus Master Example.vi"/>
				<Item Name="Modbus Slave Example.vi" Type="VI" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Examples/Modbus Slave Example.vi"/>
			</Item>
			<Item Name="Master Function Definition" Type="Folder">
				<Item Name="Master Function Definition.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Master Function Definition/Master Function Definition.lvclass"/>
			</Item>
			<Item Name="Modbus Data Unit" Type="Folder">
				<Item Name="Modbus Data Unit.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Modbus Data Unit/Modbus Data Unit.lvclass"/>
			</Item>
			<Item Name="Network Protocol" Type="Folder">
				<Item Name="Network Master" Type="Folder">
					<Item Name="Serial" Type="Folder">
						<Item Name="Serial Master.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Network Protocol/Network Master/Serial/Serial Master.lvclass"/>
					</Item>
					<Item Name="TCP" Type="Folder">
						<Item Name="TCP Master.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Network Protocol/Network Master/TCP/TCP Master.lvclass"/>
					</Item>
					<Item Name="Network Master.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Network Protocol/Network Master/Network Master.lvclass"/>
				</Item>
				<Item Name="Network Slave" Type="Folder">
					<Item Name="Serial" Type="Folder">
						<Item Name="Serial Slave.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Network Protocol/Network Slave/Serial/Serial Slave.lvclass"/>
					</Item>
					<Item Name="TCP" Type="Folder">
						<Item Name="TCP Slave.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Network Protocol/Network Slave/TCP/TCP Slave.lvclass"/>
					</Item>
					<Item Name="Network Slave.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Network Protocol/Network Slave/Network Slave.lvclass"/>
				</Item>
				<Item Name="Network Protocol.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Network Protocol/Network Protocol.lvclass"/>
				<Item Name="TCP_NODELAY.vi" Type="VI" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Network Protocol/TCP_NODELAY.vi"/>
			</Item>
			<Item Name="Serial Shared Components" Type="Folder">
				<Item Name="Serial Shared Components.lvlib" Type="Library" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Serial Shared Components/Serial Shared Components.lvlib"/>
			</Item>
			<Item Name="Standard Data Model" Type="Folder">
				<Item Name="Standard Data Model.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Standard Data Model/Standard Data Model.lvclass"/>
			</Item>
			<Item Name="TCP Shared Components" Type="Folder">
				<Item Name="TCP Shared Components.lvlib" Type="Library" URL="../c/ModbusPharLap.lvlibp/Modbus Library/TCP Shared Components/TCP Shared Components.lvlib"/>
			</Item>
			<Item Name="Transmission Data Unit" Type="Folder">
				<Item Name="ASCII" Type="Folder">
					<Item Name="ASCII Data Unit.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Transmission Data Unit/ASCII/ASCII Data Unit.lvclass"/>
				</Item>
				<Item Name="IP" Type="Folder">
					<Item Name="IP Data Unit.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Transmission Data Unit/IP/IP Data Unit.lvclass"/>
				</Item>
				<Item Name="RTU" Type="Folder">
					<Item Name="RTU Data Unit.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Transmission Data Unit/RTU/RTU Data Unit.lvclass"/>
				</Item>
				<Item Name="Serial Interface" Type="Folder">
					<Item Name="Serial Data Unit.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Transmission Data Unit/Serial Interface/Serial Data Unit.lvclass"/>
				</Item>
				<Item Name="Transmission Data Unit.lvclass" Type="LVClass" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Transmission Data Unit/Transmission Data Unit.lvclass"/>
			</Item>
			<Item Name="Utility" Type="Folder">
				<Item Name="Bits to Bytes.vi" Type="VI" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Utility/Bits to Bytes.vi"/>
				<Item Name="Bytes to Bits.vi" Type="VI" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Utility/Bytes to Bits.vi"/>
				<Item Name="Bytes to U16s.vi" Type="VI" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Utility/Bytes to U16s.vi"/>
				<Item Name="Generate UUID.vi" Type="VI" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Utility/Generate UUID.vi"/>
				<Item Name="U16s to Bytes.vi" Type="VI" URL="../c/ModbusPharLap.lvlibp/Modbus Library/Utility/U16s to Bytes.vi"/>
			</Item>
			<Item Name="Clear Errors.vi" Type="VI" URL="../c/ModbusPharLap.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Clear Errors.vi"/>
			<Item Name="Error Cluster From Error Code.vi" Type="VI" URL="../c/ModbusPharLap.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Error Cluster From Error Code.vi"/>
			<Item Name="TCP Get Raw Net Object.vi" Type="VI" URL="../c/ModbusPharLap.lvlibp/1abvi3w/vi.lib/Utility/tcp.llb/TCP Get Raw Net Object.vi"/>
			<Item Name="VISA Flush IO Buffer Mask.ctl" Type="VI" URL="../c/ModbusPharLap.lvlibp/1abvi3w/vi.lib/Instr/_visa.llb/VISA Flush IO Buffer Mask.ctl"/>
		</Item>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Modbus_CD_XML.dll" Type="Document" URL="../XML Deserializer/.NET Files/bin/Release/Modbus_CD_XML.dll"/>
